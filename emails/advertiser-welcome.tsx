...
export const AdvertiserWelcome = ({
          ...
          <Section style={box1}>
            <Section style={box2}>
              ...
              <Section style={box3}>
                ...
                <div style={{ ...content1, marginBottom: "10px" }}>
                  Welcome to AdGeist! You&apos;ve signed up as an{" "}
                  <span style={{ fontWeight: "bolder" }}>Advertiser</span>, and
                  your company{" "}
                  <span style={{ fontWeight: "bolder" }}>{companyName}</span>{" "}
                  has been successfully verified.
                </div>
                <div style={{ ...content1, marginBottom: "10px" }}>
                  You're now ready to launch campaigns, define your target
                  audience, and start tracking performance in real-time.
                </div>
                <div style={{ marginBottom: "10px" }}>
                  <div style={{...content1, fontWeight: "bolder", marginBottom: 0}}>Next Steps:</div>
                  <li style={{...content1, marginTop: 0}}>Add your first campaign</li>
                  <li style={{...content1, marginTop: 0, marginBottom: 0}}>Set up targeting & billing</li>
                </div>

                <div style={{ ...content1, marginBottom: "10px" }}>
                  You can also activate your Publisher account anytime from your
                  dashboard if you&apos;d like to monetize inventory in the
                  future.
                </div>
