...
export const CampaignRejected = ({
  ...
  url = "fnkjenfkne",
  reason="Creative policy violation"
}) => {
  return (
    <Html>
      <Head />
          ...
          <Section style={box1}>
            <Section style={box2}>
              <Section style={box3}>
                ...
                <div style={{ ...content1, marginBottom: "12px" }}>
                    Your campaign <span style={{ fontWeight: "bolder" }}>{campaignName}</span> {" "} was rejected during review.
                </div>
...
export default CampaignRejected;
