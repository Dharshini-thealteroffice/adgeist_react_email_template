import {
  ...
  export const InvitationEmail = ({ role = 'Advertiser', newRole = 'Ad Manager', invitedBy = 'Monika Surendiran', effectiveOn = 'Jan 12, 2025'}) => {
    return (
      <Html>
        <Head />
        <Body style={body}>
            ...
            <Section style={box1}>
              <Section style={box2}>
                ...
                You are invited to be an{' '}
                  <span style={title1Text}>{newRole}</span>
                </Text>
