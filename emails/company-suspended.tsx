...
export const CompanySuspended = ({
  ...
  url = "mailto:support@thealteroffice.com",
          ...
          <Section style={box1}>
            <Section style={box2}>
              <Section style={box3}>
                ...
                <div style={{ ...content1, marginBottom: "12px" }}>
                  Your company account on AdGeist has been suspended due to a
                  violation:
                </div>
                ...
                >
                  As a result, your campaigns and monetization services have
                  been paused.
                </div>
                ...
                >
                  If you believe this is a mistake or want to appeal, please get
                  in touch.
                </div>
