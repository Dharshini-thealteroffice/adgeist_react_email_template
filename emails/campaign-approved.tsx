          ...
          <Section style={box1}>
            <Section style={box2}>
              <Section style={box3}>
                ...
                <div style={{ ...content1, marginBottom: "12px" }}>
                    Your campaign <span style={{ fontWeight: "bolder" }}>{campaignName}</span> {" "} is now active and running.
                </div>
                <div style={{ ...content1, marginBottom: "12px" }}>
                 You can monitor impressions, clicks, and spend right from your dashboard.
                </div>
...
export default CompaignApproved;
