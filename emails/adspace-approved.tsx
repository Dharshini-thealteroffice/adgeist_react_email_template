          ...
          <Section style={box1}>
            <Section style={box2}>
              <Section style={box3}>
                ...
                <div style={{ ...content1, marginBottom: "12px" }}>
                    Great news! Your ad space <span style={{ fontWeight: "bolder" }}>{siteName}</span> {" "} has been approved and is now live.
                </div>
                <div style={{ ...content1, marginBottom: "12px" }}>
                  You can now start serving ads and tracking your earnings in real-time.
                </div>
...
export default AdspaceApproved;
