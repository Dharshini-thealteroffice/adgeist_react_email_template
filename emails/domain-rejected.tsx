...
export const DomainRejected = ({
  role = "Advertiser",
  firstName = "Advertiser",
  url = "fnkjenfkne",
  reason = "Low traffic quality",
}) => {
  return (
    <Html>
      <Head />
          ...
          <Section style={box1}>
            <Section style={box2}>
              <Section style={box3}>
                ...
                <div style={{ ...content1, marginBottom: "12px" }}>
                 Thanks for submitting your domain for review.
                </div>
                <div style={{ ...content1, marginBottom: "12px" }}>
                  We couldn&apos;t approve it due to the following reason:
                </div>
                ...
                <div style={{ ...content1, marginBottom: "12px", marginTop: "10px" }}>
                  Feel free to review and re-submit, or add another domain from your dashboard.
                </div>
